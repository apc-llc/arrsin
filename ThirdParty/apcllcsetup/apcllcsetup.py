...
def apcllcsetup(name, description, long_description, author, author_email, entry_points) :
    ...
    class CMakeBuild(build_ext):
        ...
        def build_extension(self, ext):
                ...
                install_dir = os.path.join(os.path.abspath(ext.sourcedir), name)
    ...
    class CMakeInstall(install_lib):
        ...
        def install(self):
                ...
                if (os.path.exists(name)):
                        dir_util.copy_tree(name, install_dir)
    ...
    class PyTest(TestCommand):
        ...
        def initialize_options(self):
                ...
                self.pytest_args = '--ignore docs --ignore ' + os.path.join('ThirdParty', name)
    ...
    setup(
        ...
        zip_safe=False,
        # We need an older more-itertools version because v6 broke pytest
        ...
        packages=[os.path.join('ThirdParty', name)],
        keywords=['pybind11', 'C++ native package'],
        classifiers=[
