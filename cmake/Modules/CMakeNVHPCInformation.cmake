...
set(CMAKE_NVHPC_SOURCE_FILE_EXTENSIONS dpcpp)
...
set(CMAKE_NVHPC_CREATE_SHARED_LIBRARY "<CMAKE_DPCXX_COMPILER> <CMAKE_SHARED_LIBRARY_CXX_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> <CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS> <SONAME_FLAG><TARGET_SONAME> -o <TARGET> <OBJECTS> <LINK_LIBRARIES>")
set(CMAKE_NVHPC_CREATE_SHARED_MODULE ${CMAKE_DPCCXX_CREATE_SHARED_LIBRARY})
set(CMAKE_NVHPC_COMPILE_OBJECT "<CMAKE_DPCXX_COMPILER> <CMAKE_SHARED_LIBRARY_CXX_FLAGS> <DEFINES> <INCLUDES> <FLAGS> -o <OBJECT> -c <SOURCE>")
set(CMAKE_NVHPC_LINK_EXECUTABLE "<CMAKE_DPCXX_COMPILER> <FLAGS> <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")
